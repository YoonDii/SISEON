...
urlpatterns = [
    ...
    path("<int:poll_id>/comments/<int:comment_pk>/delete/",views.comment_delete,name="comment_delete"),
    path("<int:poll_id>/comments/<int:comment_pk>/update/",views.comment_update,name="comment_update"),
    path("<int:poll_id>/comments/<int:comment_pk>/update/complete/",views.comment_update_complete,name="comment_update_complete"),
