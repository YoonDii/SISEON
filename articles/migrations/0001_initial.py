# Generated by Django 3.2.13 on 2022-12-07 16:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[(None, '질문유형을 선택해주세요.'), ('CS', 'CS'), ('알고리즘', '알고리즘'), ('진로', '진로'), ('오류', '오류'), ('기타', '기타')], default='질문유형을 선택해주세요.', max_length=50)),
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('content', mdeditor.fields.MDTextField()),
                ('unname', models.BooleanField(default=False)),
                ('hits', models.PositiveIntegerField(default=0, verbose_name='조회수')),
                ('q', models.CharField(default='질문', max_length=50)),
