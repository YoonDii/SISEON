...
urlpatterns = [
    ...
    path('<int:articles_pk>/recomments_create',views.recomments_create, name='recomments_create'),
    path('<int:articles_pk>/detail/<int:comment_pk>/delete/<int:recomment_pk>', views.recomments_delete, name="recomments_delete"),
