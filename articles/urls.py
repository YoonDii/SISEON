...
urlpatterns = [
    ...
    # 댓글
    path(
        "<int:articles_pk>/comment_create/", views.comment_create, name="comment_create"
    ),
    path(
        "<int:articles_pk>/comment_delete/<int:comment_pk>/delete/",
        views.comment_delete,
        name="comment_delete",
    ),
    path(
        "<int:articles_pk>/comment_update/<int:comment_pk>/update/",
